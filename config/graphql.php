...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                App\GraphQL\Queries\PrescriptionsQuery::class,
                App\GraphQL\Queries\PrescriptionQuery::class,
            ],
            'mutation' => [
                App\GraphQL\Mutations\CreatePrescriptionMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                App\GraphQL\Types\PrescriptionType::class,
        App\GraphQL\Types\PrescriptionItemInputType::class,
            ],
